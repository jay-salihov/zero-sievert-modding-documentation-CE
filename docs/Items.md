...
You can quickly create or add new items with [ItemCreate](./Functions/Items/Generic Usage/ItemCreate), however there are also tons of shortcuts for various item types such as [ItemBackpackCreate](./Functions/Items/Backpacks/ItemBackpackCreate).
